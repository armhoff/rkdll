...
Author  :   Steven Chen
----------------------------------------------------------------------*/
RKUPGRADE_API BOOL _stdcall RK_SetFirmwareW(LPCWSTR lpszFirmwarePathName);
RKUPGRADE_API BOOL _stdcall RK_SetFirmwareA(LPCSTR lpszFirmwarePathName);
#ifdef _UNICODE
...
Author  :   Seth
----------------------------------------------------------------------*/
RKUPGRADE_API int _stdcall RK_GetDeviceInfo(PDWORD pLayerArray,PDWORD pUsbTypeArray,int nArrayLen);
...
Author  :   Steven Chen
----------------------------------------------------------------------*/
RKUPGRADE_API BOOL _stdcall RK_SwitchToRockusb(DWORD dwLayer=0);
